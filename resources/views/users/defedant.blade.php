...
<html>
  ...
  <body>
    <div class="container">
      <center><h2>Defedants Form</h2><br/></center>
      <form method="post" action="{{ route('defedants')}}" enctype="multipart/form-data">
        @csrf
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-4"></div>
            <div class="form-group col-md-4">
              ...
              <input type="integer" class="form-control" name="idno">
            </div>
          </div>
        <div class="row">
          <div class="col-md-4"></div>
